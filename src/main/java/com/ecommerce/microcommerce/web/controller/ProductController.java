...
public class ProductController {
    ...
    public MappingJacksonValue calculerMargeProduit() {
    	...
    	Map<String, Integer> produitsMarge = new HashMap<String, Integer>();
    	for (Product product : produits) {
    		produitsMarge.put(product.toString(), product.getPrix() - product.getPrixAchat());
    	}
    	
    	return new MappingJacksonValue(produitsMarge);
    }
